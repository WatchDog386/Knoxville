...
const Dashboard = () => {
  ...
  const [settingsData, setSettingsData] = useState({
    siteTitle: 'knoxvilletechnologies Home Fiber',
    adminEmail: 'admin@knoxvilletechnologies.com',
    notifications: true,
    autoSave: false,
    language: 'en'
  });
    ...
    return (
        <div className={`${themeClasses.card} p-4 rounded-xl shadow-sm border backdrop-blur-sm h-full`}>
            ...
            <div className={`mt-4 pt-4 border-t ${darkMode ? 'border-gray-700' : 'border-gray-200'}`}>
                ...
                <p className={`text-xs ${darkMode ? 'text-gray-400' : 'text-gray-500'}`}>
                  <span className="font-bold mr-1">Nov 25:</span> Client Meeting (knoxvilletechnologies)
                </p>
            </div>
        </div>
    );
