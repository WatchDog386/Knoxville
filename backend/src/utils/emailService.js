...
export const generateEmailTemplate = (invoice) => {
  ...
  const companyName = process.env.COMPANY_NAME || 'knoxvilletechnologies';
  const companyEmail = process.env.COMPANY_EMAIL || 'support@knoxvilletechnologies.co.ke';
  ...
  <div class="container">
    ...
    <div class="content">
      ...
      <div class="payment-info">
        ...
        <p><strong>Account Name:</strong> ${process.env.BANK_ACCOUNT_NAME || 'knoxvilletechnologies'}</p>
...
export const sendInvoiceEmail = async (invoice) => {
  try {
    ...
    const mailOptions = {
      from: `"${process.env.COMPANY_NAME || 'knoxvilletechnologies'}" <${process.env.EMAIL_USER}>`,
      to: invoice.customerEmail,
      subject: `Invoice ${invoice.invoiceNumber} from ${process.env.COMPANY_NAME || 'knoxvilletechnologies'}`,
...
export const sendReceiptEmail = async (receipt) => {
  try {
    ...
    const mailOptions = {
      ...
      subject: `Payment Receipt ${receipt.receiptNumber} - knoxvilletechnologies`,
