...
export const generateWhatsAppMessage = (invoice) => {
  ...
  const bankAccountName = process.env.BANK_ACCOUNT_NAME || 'knoxvilletechnologies';
...
https://knoxvilletechnologies.co.ke/receipts/${receipt._id}

Need help? Call us at *${companyPhone}*  
We're happy to serve you!

— *knoxvilletechnologies Team*
`.trim();
};
...
_This is an automated connection request from the knoxvilletechnologies system_
`.trim();
};
...
🔧 *SYSTEM TEST MESSAGE*
  ...
  This is a test message from the knoxvilletechnologies invoice system.
