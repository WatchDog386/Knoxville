...
/**
 * User Schema — Represents a registered user in the knoxvilletechnologies system
 * @typedef {Object} User
 * @property {string} email - Unique, validated email address (e.g., customer@knoxvilletechnologies.com)
...
const userSchema = new mongoose.Schema({
  email: {
    ...
    match: [
      /^\w+([.-]?\w+)*@\w+([.-]?\w+)*(\.\w{2,3})+$/,
      'Please enter a valid email address (e.g., user@knoxvilletechnologies.com)'
    ]
  },
  password: {
    type: String,
...
// ✅ Virtual field: Masked email for public display (e.g., "j***n@knoxvilletechnologies.com")
